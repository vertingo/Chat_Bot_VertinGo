...
Enregistrer votre chat bot dans la Bot Channel Registration pour rÈcupÈrer les identifiants qu'il faudra remplacer dans Web.config dans le projet en .NET!
...
Dans un premier temps il faut renseigner les variables botFilePath et botFileSecret dans appsettings.json en les rÈcupÈrant depuis le portail Azure dans ParamËtres ensuite pour dÈployer il 
...
Cliquer sur Publier et on vous demande de taper le mot de passe! Coller le mot passe copier prÈcÈdement et votre chat-bot sera publiÈ ou plutÙt mettra ‡† jour la version prÈcÈdente sur Azure!
...
et dans Visual Studio Code exÈcuter le chat-bot pour qu'il puisse Ítre accessible depuis le localhost et ouvrer le fichier .bot!
